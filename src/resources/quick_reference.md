...
| Force a re-index or check indexing statistics | `index_project`                 |
| Annotate a file                               | `annotate`                      |
| Read annotation for a file                    | `get_annotation`                |
| What files haven't been annotated?            | `list_unannotated_files`        |
